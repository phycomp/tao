...
@login_required
def avatar_add(request, extra_context=None, next_override=None,
...
@login_required
def avatar_change(request, extra_context=None, next_override=None,
...
@login_required
def avatar_delete(request, extra_context=None, next_override=None, *args, **kwargs):
    if extra_context is None:
        extra_context = {}
    avatar, avatars = _get_avatars(request.user)
